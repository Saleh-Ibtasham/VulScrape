...
def api_slice(working_directory):
    slice_point_path = working_directory + "slice_points/"
    slice_file_path = working_directory + "slice_files/"
    count = 1
    store_filepath = slice_file_path + "api_slices.txt"
    f = open(slice_point_path + "sensifunc_slice_points.pkl", 'rb')
    ...
    for key in dict_unsliced_sensifunc.keys():#key is testID
        ...
        for _t in dict_unsliced_sensifunc[key]:
            ...
            if sensitive_funcname.find("main") != -1:
                ...
                if list_code == []:
                    fout = open(slice_point_path + "error.txt", 'a')
...
def pointers_slice(working_directory):
    slice_point_path = working_directory + "slice_points/"
    slice_file_path = working_directory + "slice_files/"
    count = 1
    store_filepath = slice_file_path + "pointersuse_slices.txt"
    f = open(slice_point_path + "pointuse_slice_points.pkl", 'rb')
...
def arrays_slice(working_directory):
    slice_point_path = working_directory + "slice_points/"
    slice_file_path = working_directory + "slice_files/"
    count = 1
    store_filepath = slice_file_path + "arraysuse_slices.txt"
    f = open(slice_point_path + "arrayuse_slice_points.pkl", 'rb')
    dict_unsliced_pointers = pickle.load(f)
    f.close()
...
def integeroverflow_slice(working_directory):
    slice_point_path = working_directory + "slice_points/"
    slice_file_path = working_directory + "slice_files/"
    count = 1
    store_filepath = slice_file_path + "expr_slices.txt"
    f = open(slice_point_path + "expr_slice_points.pkl", 'rb')
    dict_unsliced_expr = pickle.load(f)
    f.close()

    l = ['CVE-2016-5259', 'CVE-2015-7512', 'CVE-2016-2532', 'CVE-2014-3640', 'CVE-2016-5106', 'CVE-2016-5107', 'CVE-2016-4453', 'CVE-2015-4475', 'CVE-2016-6835', 'CVE-2016-4454', 'CVE-2016-5257', 'CVE-2015-7220', 'CVE-2015-7221', 'CVE-2016-5278', 'CVE-2016-1981', 'CVE-2015-2726', 'CVE-2016-2857', 'CVE-2013-0858', 'CVE-2014-0182', 'CVE-2013-0856', 'CVE-2013-0857', 'CVE-2016-5403', 'CVE-2014-2099', 'CVE-2014-2098', 'CVE-2015-1779', 'CVE-2016-6833', 'CVE-2014-2097', 'CVE-2015-7203', 'CVE-2015-7194', 'CVE-2015-6820', 'CVE-2015-7199', 'CVE-2015-2710', 'CVE-2016-4952', 'CVE-2015-2712', 'CVE-2013-7022', 'CVE-2013-7023', 'CVE-2013-0845', 'CVE-2016-7466', 'CVE-2015-7202', 'CVE-2013-4151', 'CVE-2013-4150', 'CVE-2016-8668']
...
def deliverProgramSlices(working_directory):
    change_directory(working_directory)
    api_slice(working_directory)
    pointers_slice(working_directory)
    arrays_slice(working_directory)
    integeroverflow_slice(working_directory)
